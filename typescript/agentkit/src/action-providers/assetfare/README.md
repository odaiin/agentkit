...
handoff pinned to `assetfare-mcp@1.5.3`. Because this provider deliberately does not expose the raw
...
The 1.5.3 session capability preserves the strict verification context so every later session action
