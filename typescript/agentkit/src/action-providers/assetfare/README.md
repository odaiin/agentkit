...
handoff pinned to `assetfare-mcp@1.6.0`. Because this provider deliberately does not expose the raw
...
The 1.6.0 session capability preserves the strict verification context so every later session action
